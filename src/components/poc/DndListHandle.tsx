...
export default function DndListHandle({ initialData }: Props) {
                    ...
                    {tasks.map((task, taskIndex) => (
                      ...
                      >
                        {(providedDraggable, snapshotDraggable) => (
                          <div
                            className={cn(
                              "p-2 m-2 border bg-white flex items-center",
                          ...
                          >
                            <div
                              className="items-center mr-2 bg-orange-500 rounded-sm"
                              {...providedDraggable.dragHandleProps}
                            >
                              <GripVerticalIcon className="w-4 h-4 m-1 mx-auto text-white" />
                            </div>
                            <p>
                              {`${task.content}`}
                              {` - ${task.id} `}
